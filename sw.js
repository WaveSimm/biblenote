...
const SHELL = [
  ...
  "js/xref.js", "js/swipe.js", "js/drivesync.js",
  "data/books.json", "data/versions.json", "data/headings.json", "data/headings-en.json",
  "manifest.webmanifest", "icons/icon-192.png", "icons/icon-512.png",
];

// books.json·versions.json 은 data/ 아래 있지만 셸이다 — 번역본을 추가하면 바뀐다.
// 불변 취급해 DATA 에 넣으면 새 번역본이 기존 설치 기기에 영영 나타나지 않는다.
const isShellJson = (url) => /\/data\/(books|versions|headings|headings-en)\.json$/.test(url.pathname);
const isData = (url) =>
